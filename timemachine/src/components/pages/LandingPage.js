              ...
              >
                <div className="flex items-center flex-1 md:absolute md:inset-y-0 md:left-0">
                  <div className="flex items-center justify-between w-full md:w-auto">
                    <a href="#">
                      <span className="sr-only">TimeMachine</span>
                      <img className="h-12 w-auto sm:h-10" src={logo} alt="" />
                    </a>
          ...
          <div className="mt-16 mx-auto max-w-7xl px-4 sm:mt-24 sm:px-6">
            <div className="text-center">
              <h1 className="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl">
                <span className="block">TimeMachine</span>
              </h1>
              <p className="mt-3 max-w-md mx-auto text-base text-gray-500 sm:text-lg md:mt-5 md:text-xl md:max-w-3xl">
                Have you ever wondered what it might be like to have a time
                machine, and go back and talk to some of history's greatest
                people? Wonder no more.
              </p>
            </div>
          </div>
        </div>
